...
for i = 1:Nsamples
    ...
    plot3( x( px, i:( i + 1 ) ), x( py, i:( i + 1 ) ), x( pz, i:( i + 1 ) ), '-', 'linewidth', 2, 'Color', color{ helper } ); 
end
...
set(get(gca,'XLabel'),'Position',[ 0.5 -0.05 ]);
set(get(gca,'YLabel'),'Position',[ -0.05 0.5 ]);
set(get(gca,'ZLabel'),'Position',[ 0.05 1.05 0.5 ])
